...
c_sub <- read.csv("/Users/joseph/Dropbox/Research Projects/WelfareMetaAnalysis/Data/Data_child_prepped.csv") %>%
  select(source, id)

data <- read.csv("/Users/joseph/Dropbox/Research Projects/WelfareMetaAnalysis/Data/Data_prepped.csv") %>%
...
model <- read.csv("/Users/joseph/Dropbox/Research Projects/WelfareMetaAnalysis/julia/output/modelfit_exante_K5.csv") %>%
